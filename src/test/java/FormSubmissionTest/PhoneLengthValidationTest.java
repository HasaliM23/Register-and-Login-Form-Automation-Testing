...
public class PhoneLengthValidationTest {
    ...
    public void verifyPhoneWithShortLengthIsRejected() {
        ...
        WebElement phoneError = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//p[.='Contact must be at least 11 characters']")
        ));
