...
public class InvalidEmailFormatTest {
    ...
    public void verifyInvalidEmailFormatShowsError() {
        ...
        email.sendKeys("KolinWagengmail.com");
...
// Wait for error message
        Boolean isInvalidEmail = (Boolean) ((JavascriptExecutor) driver)
                .executeScript("return arguments[0].validity.typeMismatch;", email);

        Assert.assertTrue(isInvalidEmail,
                "Invalid email format was accepted — BUG!");
