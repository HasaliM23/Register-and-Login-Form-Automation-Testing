...
public class EmptyEmailFieldTest {
    ...
    public void verifyEmptyEmailShowsRequiredMessage() {
        ...
        WebElement errorMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//p[.='Email is a required field']")
        ));

        // ASSERT error message
        Assert.assertEquals(errorMsg.getText(), "Email is a required field",
