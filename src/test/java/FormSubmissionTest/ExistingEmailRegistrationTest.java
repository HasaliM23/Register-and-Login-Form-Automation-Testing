...
public class ExistingEmailRegistrationTest {
    ...
    public void verifyRegistrationWithExistingEmailShowsError() {
        ...
        // check URL did NOT change to success page
        String currentUrl = driver.getCurrentUrl();
        Assert.assertTrue(currentUrl.contains("form-submission"),
                "Form submitted with existing email — TEST FAILED!");
