...
public class EmptyPhoneFieldTest {
    ...
    public void verifyEmptyPhoneShowsRequiredMessage() {
        ...
        WebElement errorMsg = wait.until(ExpectedConditions.visibilityOfElementLocated(
                By.xpath("//p[.='Contact is a required field']")
        ));

        // ASSERT error message
        Assert.assertEquals(errorMsg.getText(), "Contact is a required field",
